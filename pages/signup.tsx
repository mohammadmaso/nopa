    ...
    <Box p="20px" rounded="5px" borderWidth={2}>
      <Box textAlign="left">
        ...
        <Text mb="14px" fontSize="14px" lineHeight="20px">
          Enter your email below to get notified about the new roadmaps, guides
          and updates
        </Text>

        <form
          action="https://www.getrevue.co/profile/roadmap/add_subscriber"
          method="post"
          target="_blank"
        >
          <Input
...
function PaidSignUp() {
  return (
    ...
    >
      ...
      <Text mb="20px" fontSize="14px" lineHeight="20px">
        People sponsoring me on GitHub get access to the updates as well as paid
        content.
      </Text>
      ...
      <List spacing={2}>
        ...
        <ListItem fontSize="14px">
          ...
          <Link fontWeight={600} textDecoration="underline" href="/thanks">
            Thanks
          </Link>
        </ListItem>
      </List>
